...
#include "config/outbit-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatOutbitURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + OutbitUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatOutbitURI(info));
}
