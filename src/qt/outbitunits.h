...
#ifndef OUTBIT_QT_OUTBITUNITS_H
#define OUTBIT_QT_OUTBITUNITS_H
...
/** Outbit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class OutbitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit OutbitUnits(QObject *parent);

    /** Outbit units.
      @note Source: https://en.outbit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        UBT,
...
typedef OutbitUnits::Unit OutbitUnit;

#endif // OUTBIT_QT_OUTBITUNITS_H
