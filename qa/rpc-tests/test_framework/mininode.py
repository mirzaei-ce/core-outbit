# mininode.py - Outbit P2P network half-a-node
#
...
#
# NodeConn: an object which manages p2p connectivity to a outbit node
...
# Objects that map to outbitd objects, which can be serialized/deserialized
...
class msg_headers(object):
    ...
    def deserialize(self, f):
        # comment in outbitd indicates these should be deserialized as blocks
...
class NodeConn(asyncore.dispatcher):
    ...
    def __init__(self, dstaddr, dstport, rpc, callback, net="regtest", services=1):
        ...
        print 'MiniNode: Connecting to Outbit Node IP # ' + dstaddr + ':' \
            + str(dstport)
