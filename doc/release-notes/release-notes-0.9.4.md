Outbit Core version 0.9.4 is now available from:

  https://outbit.org/bin/0.9.4/
...
this update is incompatible with the Outbit system and could lead to consensus
forks.

Outbit Core released binaries from https://outbit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~outbit/+archive/ubuntu/outbit
- A third-party or self-compiled Outbit Core

upgrade to Outbit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
