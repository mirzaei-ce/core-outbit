...
unlocked to sign the Outbit-Qt.app bundle.
...
allowing somebody to distribute a Outbit-Qt.app or outbit-qt-setup.exe with a valid
...
that the outbit-qt.exe file inside the installer had not been tampered with.
