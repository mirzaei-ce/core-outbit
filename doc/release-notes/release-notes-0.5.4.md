Outbit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/outbit/files/Outbit/outbit-0.5.4/
...
http://gitorious.org/outbit/outbitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Outbit-Qt notifications under Growl 1.3.
Increase required age of Outbit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxOutbit properly when installing Outbit-Qt over it. (Windows)
