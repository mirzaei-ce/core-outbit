...
#ifndef OUTBIT_TEST_SCRIPTNUM10_H
#define OUTBIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Outbit Core 0.10.0, for cross-comparison.
 */
public:
