Outbit version 0.7.2 is now available from:
  http://sourceforge.net/projects/outbit/files/Outbit/outbit-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused Outbit-Qt to crash on Windows when exiting.
