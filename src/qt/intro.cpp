...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/outbit"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Outbit Core"),
     ...
     * override -datadir in the outbit.conf file in the default data directory
     * (to be consistent with outbitd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
