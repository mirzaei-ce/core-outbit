...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    COutbitAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    COutbitAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = COutbitAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = COutbitAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(COutbitAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(COutbitAddress(arr[0].get_str()).Get() == demoAddress.Get());
