Outbit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/outbit/files/Outbit/outbit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Outbit
...
New/changed settings (command-line or outbit.conf file)
--------------------------------------------------------
